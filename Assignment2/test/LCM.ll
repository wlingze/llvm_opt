...
; RUN:     %s -o %basename_t --enable-new-pm=0 2>%basename_t.antiexpr.log
...
; RUN:     %s -o %basename_t --enable-new-pm=0 2>%basename_t.wbavailexpr.log
...
; RUN:     %s -o %basename_t  --enable-new-pm=0 2>%basename_t.eplace.log 
